          ...
          <div className="row">
            ...
            <div className="col-6">
              <div className="text-end text-white mb-0">
                Hotline:{" "}
                <a href="tel:+84 977771467" className="text-white">
                  +84 977771467
                </a>
              </div>
            </div>
      ...
      <header className="header-upper py-3">
        <div className="container-xxl">
          <div className="row align-items-center">
            <div className="col-2">
              <h3>
                <Link to="" className="text-white h2">
                  Bookstore
                </Link>
              </h3>
            </div>
            ...
            <div className="col-12">
              <div className="menu-bottom d-flex align-items-center gap-30">
                <div className="dropdown">
                  <button
                    className="align-items-center  gap-15 btn btn-secondary dropdown-toggle bg-transparent border-0 d-flex"
                    type="button"
