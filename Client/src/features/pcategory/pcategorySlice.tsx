...
import pCategoriesService from "./pcategoryService";

export const getProductCategories = createAsyncThunk(
  "pCategory/get-pCategories",
  async (thunkAPI:any) => {
    try {
      return await pCategoriesService.getProductCategories();
    } catch (error) {
...
export const createCategory = createAsyncThunk(
  ...
  async (categoryData, thunkAPI) => {
    try {
      return await pCategoriesService.createCategory(categoryData);
    } catch (error) {
      return thunkAPI.rejectWithValue(error);
    }
  }
...
export const updateAProductCategory = createAsyncThunk(
  ...
  async (category, thunkAPI) => {
    try {
      return await pCategoriesService.updateProductCategory(category);
    } catch (error) {
      return thunkAPI.rejectWithValue(error);
    }
  }
...
export const deleteAProductCategory = createAsyncThunk(
  ...
  async (id, thunkAPI) => {
    try {
      return await pCategoriesService.deleteProductCategory(id);
    } catch (error) {
      return thunkAPI.rejectWithValue(error);
    }
  }
...
export const getAProductCategory = createAsyncThunk(
  ...
  async (id, thunkAPI) => {
    try {
      return await pCategoriesService.getProductCategory(id);
    } catch (error) {
      return thunkAPI.rejectWithValue(error);
    }
  }
...
export const pcategorieSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getProductCategories.rejected, (state:any, action) => {
        state.isLoading = false;
        state.isError = true;
